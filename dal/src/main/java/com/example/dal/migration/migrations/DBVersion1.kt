...
class DBVersion1 : AbstractMigration() {
    ...
    override fun up() {
        ...
        firm1.Fields.add(FieldDto(FieldSetting.FIELD_NAME, "2ГИС, городской информационный справочник"))
        firm1.Fields.add(FieldDto(FieldSetting.FIELD_ADDRESS_NAME, "пл. Карла Маркса 7"))
        firm1.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_NAME, "ДубльГИС"))
        firm1.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_FORM, mutableListOf(1000L)))
        firm1.Fields.add(FieldDto("Floor", "14"))

        val firm2 = FirmDto(2)
        firm2.Fields = hashSetOf()
        firm2.Fields.add(FieldDto(FieldSetting.FIELD_NAME, "Додо Пицца, федеральная сеть пицерий"))
        firm2.Fields.add(FieldDto(FieldSetting.FIELD_ADDRESS_NAME, "Красный проспект 17"))
        firm2.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_NAME, "Ромашка"))
        firm2.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_FORM, mutableListOf(1001L)))

        val firm3 = FirmDto(3)
        firm3.Fields = hashSetOf()
        firm3.Fields.add(FieldDto(FieldSetting.FIELD_NAME, "Прайм-сервис, специализированный сервис по ремонту"))
        firm3.Fields.add(FieldDto(FieldSetting.FIELD_ADDRESS_NAME, "Энергетиков проезд, 8 / 3"))
        firm3.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_NAME, "ИП Васильев"))
        firm3.Fields.add(FieldDto(FieldSetting.FIELD_LEGAL_FORM, mutableListOf(1003L)))
        ...
        saveFieldSetting(1, ObjectType.Firm.id, FieldSetting.TYPE_TEXT, "Название", FieldSetting.FIELD_NAME, null, 1)
        saveFieldSetting(2, ObjectType.Firm.id, FieldSetting.TYPE_TEXT, "Адрес", FieldSetting.FIELD_ADDRESS_NAME, null, 2)
        saveFieldSetting(3, ObjectType.Firm.id, FieldSetting.TYPE_TEXT, "Юр. название", FieldSetting.FIELD_LEGAL_NAME, null, 3)
        saveFieldSetting(4, ObjectType.Firm.id, FieldSetting.TYPE_BOOL_SINGLE, "ОПФ", FieldSetting.FIELD_LEGAL_FORM, "legal_form", 4)
